...
def main():
    ...
    for idx, sigma in enumerate(sigma_values):
        ...
        print(f"  LSM RMS = {rms_ls[-1]:.4e}, MLE RMS = {rms_mle[-1]:.4e}")
    ...
    plt.grid(True)
    plt.legend()
    plt.title('RMS Error vs. Noise Level')
    plt.savefig('fig3_rms_comparison.png', dpi=300)
    plt.show()
