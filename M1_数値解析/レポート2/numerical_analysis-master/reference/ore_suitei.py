...
# 画像の読み込み
img_in = cv2.imread("image/in_out/ore_input.jpg", cv2.IMREAD_GRAYSCALE)
img_out = cv2.imread("image/in_out/ore_output.jpg", cv2.IMREAD_GRAYSCALE)
# 画像の大きさ
